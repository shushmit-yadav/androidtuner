...
public class PitchDetector implements Runnable {
	private static String LOG_TAG = "PitchDetectionRepresentation";
	...
	private final static int MIN_FREQUENCY = 49; // 49.0 HZ of G1 - lowest note for crazy Russian choir.
	private final static int MAX_FREQUENCY = 1568; // 1567.98 HZ of G6 - highest demanded note in the classical repertoire
